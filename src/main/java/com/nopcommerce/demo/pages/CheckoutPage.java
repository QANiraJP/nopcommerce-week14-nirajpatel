...
public class CheckoutPage extends Utility {
    ...
    public void enterEmail() {
        sendTextToElement(emailField, "testn1234@gmail.com");
    }
    ...
    public void enterAddressField1Nokia() {
        sendTextToElement(addressField1Nokia, "06 Jubilee Court");
    }

    public void enterZipCodeNokia() {
        sendTextToElement(zipCodeNokia, "Cr7 6jl");

    }

    public void enterPhoneNumberNokia() {
        sendTextToElement(phoneNumberNokia, "0123456789");
    }
    ...
    public void enterCardHolderNameNokia() {
        sendTextToElement(cardHolderNameNokia, "Mr qwerty asdf");
    }
